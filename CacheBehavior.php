<?php
/*
CacheBehavior class is designed to create an intelligent caching system using Yii's built in caching methods. Here
we will create a several components to identify the cache key:
